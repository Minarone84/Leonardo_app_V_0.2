...
TRACKED_GUI_ACTION_DEFINITIONS: tuple[ActionDefinition, ...] = (
    ...
    ActionDefinition(
        ...
        window_id="main_window.window",
        is_placeholder=True,
        metadata={"target_window_id": "research_suite.window", "status": "shell_only"},
    ),
    ActionDefinition(
        ...
        window_id="main_window.window",
        is_placeholder=True,
        metadata={"target_window_id": "data_manager_suite.window", "status": "shell_only"},
    ),
    ActionDefinition(
        ...
        window_id="main_window.window",
        is_placeholder=True,
        metadata={"target_window_id": "analysis_suite.window", "status": "shell_only"},
    ),
    ActionDefinition(
        ...
        window_id="main_window.window",
        is_placeholder=True,
        metadata={"target_window_id": "trading_suite.window", "status": "shell_only"},
    ),
    ActionDefinition(
        action_id="historical_download_manager.select_all_timeframes",
        label="Select All Timeframes",
        kind=ActionKind.BUTTON,
        window_id="historical_download_manager.window",
    ),
    ActionDefinition(
        action_id="historical_download_manager.clear_timeframes",
        label="Clear/Deselect All Timeframes",
        kind=ActionKind.BUTTON,
        window_id="historical_download_manager.window",
    ),
    ActionDefinition(
        action_id="historical_download_manager.start",
        label="Start",
        kind=ActionKind.BUTTON,
        window_id="historical_download_manager.window",
    ),
    ActionDefinition(
        action_id="historical_download_manager.stop",
        label="Stop",
        kind=ActionKind.BUTTON,
        window_id="historical_download_manager.window",
    ),
    ActionDefinition(
        action_id="historical_download_manager.ohlcv_maintenance",
        label="OHLCV Maintenance",
        kind=ActionKind.BUTTON,
        window_id="historical_download_manager.window",
    ),
    ActionDefinition(
        action_id="research_suite.action.load_dummy_workspace",
        label="Load Dummy Workspace",
        kind=ActionKind.BUTTON,
        window_id="research_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="research_suite.action.reset_dummy_workspace",
        label="Reset Dummy Workspace",
        kind=ActionKind.BUTTON,
        window_id="research_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="research_suite.action.add_chart_placeholder",
        label="Add Chart Placeholder",
        kind=ActionKind.BUTTON,
        window_id="research_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="data_manager.action.load_dummy_catalogs",
        label="Load Dummy Catalogs",
        kind=ActionKind.BUTTON,
        window_id="data_manager_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="data_manager.action.preview_dummy_dataset",
        label="Preview Dummy Dataset",
        kind=ActionKind.BUTTON,
        window_id="data_manager_suite.window",
        is_placeholder=True,
    ),
    ...
    ActionDefinition(
        action_id="analysis_suite.action.load_dummy_state",
        label="Load Dummy Analysis State",
        kind=ActionKind.BUTTON,
        window_id="analysis_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="analysis_suite.action.preview_target_plan",
        label="Preview Target Plan",
        kind=ActionKind.BUTTON,
        window_id="analysis_suite.window",
        is_placeholder=True,
    ),
    ActionDefinition(
        action_id="analysis_suite.action.preview_diagnostics",
    ...
    ActionDefinition(
        action_id="trading_suite.action.preview_paper_shell",
        label="Preview Paper Shell",
        kind=ActionKind.BUTTON,
        window_id="trading_suite.window",
        is_placeholder=True,
    ),
